# Vlm's Universal Blue OS

[![build-ublue](https://github.com/valmar/vlm-ublue-os/actions/workflows/build.yml/badge.svg)](https://github.com/valmar/vlm-ublue-os/actions/workflows/build.yml)
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/valmar/vlm-ublue-os:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/valmar/vlm-ublue-os:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/valmar:vlm-ublue-os:20230403
```
